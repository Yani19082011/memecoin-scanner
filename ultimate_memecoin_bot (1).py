...
class UltimateMemecoinBot:
    def __init__(self):
        ...
        # Програмата автоматично взима стойността от Render и я разделя правилно по запетаите
    ...
    def send_email_notification(self, subject: str, body: str):
        ...
        if self.sender_email == "YOUR_EMAIL@gmail.com" or self.sender_password == "YOUR_GMAIL_APP_PASSWORD":
            logging.warning("Имейлът не е изпратен! Моня, конфигурирайте реални sender_email и sender_password in __init__.")
            return
